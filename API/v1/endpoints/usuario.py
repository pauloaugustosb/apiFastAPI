...
from Schema.usuario_schema import UsuarioSchemaBase, UsuarioSchemaArtigos, UsuarioSchemaCreate, UsuarioSchemaUp
...
#   GET - LOGADO: usuario que autenticou
@router.get('/logado', response_model=UsuarioSchemaBase)
def get_logado(usuario_logado: UsuarioModel = Depends(get_current_user)):
    return usuario_logado


#   POST - Sign Up: criar o usuário
...
async def login(form_data: OAuth2PasswordRequestForm = Depends(),
    ...
    return JSONResponse(content={"access_token": criar_token_acess(sub=usuario.id),
                                     "token_type": "bearer"},
